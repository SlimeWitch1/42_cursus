...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/13 15:13:30 by turocha-          #+#    #+#             */
/*   Updated: 2025/06/13 15:13:35 by turocha-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	printf("%d\n", ft_atoi_base(" 	+--545464639", "0123456789abcdef"));
	printf("%d\n", ft_atoi_base("4242", "0123456789"));
	printf("%d\n", ft_atoi_base("42", "fruit"));
}
*/